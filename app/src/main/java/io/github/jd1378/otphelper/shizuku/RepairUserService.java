...
/** Short-lived Shizuku UserService that runs narrowly scoped repair commands as shell/root. */
@Keep
  ...
  private String runCommand(String command) throws RemoteException {
    ...
    try {
      ...
      RemoteException remoteException =
          new RemoteException("Unable to run repair command: " + command);
      remoteException.initCause(e);
      throw remoteException;
    } catch (InterruptedException e) {
      Thread.currentThread().interrupt();
      RemoteException remoteException =
          new RemoteException("Repair command interrupted: " + command);
      remoteException.initCause(e);
      throw remoteException;
    } finally {
